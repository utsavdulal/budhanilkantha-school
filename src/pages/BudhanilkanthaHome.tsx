...
export default function BudhanilkanthaHome() {
  return (
...
<a className="text-tertiary-fixed hover:text-white font-semibold transition-colors duration-150 inline-flex items-center gap-1 underline underline-offset-4" href="/admissions">
...
<Link className="text-on-surface font-medium hover:text-on-tertiary-container font-body-sm text-[14px] transition-colors" to="/about">About</Link>
<Link className="text-on-surface font-medium hover:text-on-tertiary-container font-body-sm text-[14px] transition-colors" to="/academics">Academics</Link>
...
<Link className="text-on-surface font-medium hover:text-on-tertiary-container font-body-sm text-[14px] transition-colors" to="/about#charter">Student Life</Link>
...
<Link className="text-on-surface font-medium hover:text-on-tertiary-container font-body-sm text-[14px] transition-colors" to="/admissions">Contact</Link>
</nav>
...
<Link className="inline-flex items-center justify-center bg-primary-container hover:bg-primary text-on-primary font-label-caps text-[11px] uppercase tracking-widest px-space-lg py-2.5 rounded transition-all shadow-[0_2px_6px_rgba(15,30,54,0.15)] active:scale-[0.99]" to="/admissions">
            Apply for Admission
          </Link>
</div>
</div>
...
<a className="w-full inline-flex items-center justify-center px-space-lg py-space-sm bg-tertiary-fixed hover:bg-tertiary-fixed-dim text-primary font-label-caps text-[11px] uppercase tracking-wider rounded font-bold transition-all shadow-md active:scale-[0.99]" href="/academics">
                    Explore Academic Wings
                  </a>
<a className="w-full inline-flex items-center justify-center px-space-lg py-space-sm bg-white/10 hover:bg-white/20 text-white border border-white/20 font-label-caps text-[11px] uppercase tracking-wider rounded transition-all" href="/admissions">
...
<a className="inline-flex items-center gap-1.5 text-primary font-label-caps text-[11px] uppercase tracking-wider font-bold group-hover:text-on-tertiary-container" href="/admissions">
...
<div className="pt-space-lg">
<a className="inline-flex items-center gap-1.5 text-tertiary-fixed font-label-caps text-[11px] uppercase tracking-wider font-bold hover:underline" href="/admissions">
...
<a className="group inline-flex items-center gap-space-xs text-primary font-label-caps text-label-caps uppercase tracking-wider font-semibold hover:text-on-tertiary-container" href="/admissions">
...
<a className="text-on-tertiary-container font-label-caps text-[11px] uppercase tracking-wider font-bold hover:underline" href="/admissions">
                  Apply Online Now →
                </a>
...
<div className="pt-space-md border-t border-outline-variant/30 flex items-center justify-between">
<a className="text-on-tertiary-container font-label-caps text-[11px] uppercase tracking-wider font-bold hover:underline" href="/about">
                  View Photo Gallery →
                </a>
...
<form className="space-y-space-sm" onSubmit={(e) => { e.preventDefault(); alert("Inquiry submitted successfully!"); }}>
<div>
...
<li><a className="hover:text-on-surface transition-colors" href="/academics">Pre-Primary (PG–UKG)</a></li>
<li><a className="hover:text-on-surface transition-colors" href="/academics">Primary School (1–5)</a></li>
<li><a className="hover:text-on-surface transition-colors" href="/academics">Lower Secondary (6–8)</a></li>
<li><a className="hover:text-on-surface transition-colors" href="/academics">Secondary Wing (9 &amp; 10)</a></li>
<li><a className="hover:text-on-surface transition-colors" href="/academics">SEE Board Distinction</a></li>
